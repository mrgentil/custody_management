                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            @php
                                $avatarText = strtoupper(substr(auth()->user()->name, 0, 2));
                                $avatarColor = '#' . substr(md5(auth()->user()->name), 0, 6); // Utilisez une couleur générée à partir du nom
                            @endphp

                            @if(auth()->user()->avatar)
                                <img class="rounded-circle header-profile-user"
                                     src="{{ asset( auth()->user()->avatar) }}" alt="Image de profil">
                            @else
                                <div class="rounded-circle header-profile-user" class="avatar"
