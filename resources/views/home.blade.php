                    ...
                    <div class="h-100">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0">Voici ce qui se passe dans application
                                            aujourd'hui.</p>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                                        class="counter-value"
                                                        data-target="{{$formattedTotalArmes}}">{{$formattedTotalArmes}}</span></h4>
                                                <a href="{{route(('weapons.index'))}}"
                                                   class="text-decoration-underline">Voir armes</a>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                                        class="counter-value"
                                                        data-target="{{$formattedTotalUsers}}">{{$formattedTotalUsers}}</span></h4>
                                                <a href="{{route('users.index')}}" class="text-decoration-underline">Voir
                                                    utilisateurs</a>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                                        class="counter-value"
                                                        data-target="{{$formattedTotalGuards}}">{{$formattedTotalGuards}}</span></h4>
                                                <a href="{{route('guards.index')}}" class="text-decoration-underline">Voir
                                                    gardes</a>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span
                                                        class="counter-value"
                                                        data-target="{{$formattedTotalCustomers}}">{{$formattedTotalCustomers}}</span></h4>
                                                <a href="{{route('customers.index')}}"
                                                   class="text-decoration-underline">Voir clients</a>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="card-header p-0 border-0 bg-light-subtle">
                                        <div class="row g-0 text-center">
                                            <div class="col-6 col-sm-3">
                                                <div class="p-3 border border-dashed border-start-0">
                                                    <h5 class="mb-1"><span class="counter-value"
                                                                           data-target="{{ $totalArmes }}">{{ $totalArmes }}</span>
                                                    </h5>
                                                    <p class="text-muted mb-0">Armes</p>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-6 col-sm-3">
                                                <div class="p-3 border border-dashed border-start-0">
                                                    <h5 class="mb-1"><span class="counter-value"
                                                                           data-target="{{ $totalUsers }}">{{ $totalUsers }}</span>k
                                                    </h5>
                                            ...
                                            <div class="col-6 col-sm-3">
                                                <div class="p-3 border border-dashed border-start-0">
                                                    <h5 class="mb-1"><span class="counter-value"
                                                                           data-target="{{ $totalGustomers }}">{{ $totalGustomers }}</span>
                                                    </h5>
                                            ...
                                            <div class="col-6 col-sm-3">
                                                <div class="p-3 border border-dashed border-start-0 border-end-0">
                                                    <h5 class="mb-1 text-success"><span class="counter-value"
                                                                                        data-target="{{ $totalGuards }}">{{ $totalGuards }}</span>%
                                                    </h5>
                                                    <p class="text-muted mb-0">Gardes</p>
                                                </div>
                                            </div>
                                            <!--end col-->
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Clients Ajouter Recemment</h4>
                                        <div class="flex-shrink-0">
                                            <a href="{{route('customers.export')}}"
                                               class="btn btn-soft-info btn-sm shadow-none">
                                                <i class="ri-file-list-3-line align-middle"></i> Exporter
                                            </a>
                                        </div>
                                    </div><!-- end card header -->
                                                ...
                                                <tr>
                                                    <th scope="col" style="width: 50px;">
                                                        <div class="form-check">
                                                            <label for="checkAll"></label><input
                                                            ...
                                                            <div class="avatar-group">
                                                                @if ($customer->avatar)
                                                                    <a href="javascript: void(0);"
                                                                       class="avatar-group-item" data-img="avatar-3.jpg"
                                                                ...
                                                                @else
                                                                    <a href="javascript: void(0);"
                                                                       ...
                                                                       data-img="userProfil.jpg"
                                                                       data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                       data-bs-placement="top" title="Username">
                                                                        <img src="{{ asset('userProfil.jpg') }}" alt=""
